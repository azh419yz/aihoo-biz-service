...
import com.aihoo.api.doctor.app.controller.request.*;
...
import com.aihoo.api.doctor.common.constant.DictTypeEnum;
import com.aihoo.api.doctor.common.constant.StatusEnumUtil;
import com.aihoo.api.doctor.common.utils.AuthUtil;
import com.aihoo.api.doctor.common.utils.OrderNoUtil;
import com.aihoo.api.doctor.common.utils.TencentImGroupUtil;
...
public class PrescriptionServiceImpl extends ServiceImpl<HosPrescriptionMapper, HosPrescription> implements PrescriptionService {
    ...
    public JsonResult sign(Map<String, String> map) {
        ...
        boolean sealUrl = getSealUrl(Objects.requireNonNull(AuthUtil.getLoginUser()).getPapersNumbers(), hosPrescription);
        if (sealUrl) {
