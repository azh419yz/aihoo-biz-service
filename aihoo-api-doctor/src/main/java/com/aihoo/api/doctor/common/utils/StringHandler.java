...
public class StringHandler {
	 ...
	 * 向右截取字符串
	 * @param str 原串
	 * @param separatorChars 拆分字段
	 * @return
	 */
	public static String rightSubStr(String str, String separatorChars){
		if(equals(str, "null"))
			return null;
		int begin=str.indexOf(separatorChars);
		int last=str.length();
		String substring = str.substring(begin + 1, last);
		return substring;
	}

	public static void main(String[] args) {
		String str = "From_Account";
		String s = rightSubStr(str, "_");
