...
import com.aihoo.api.doctor.common.constant.MdtTypeEnum;
import com.aihoo.api.doctor.common.constant.StatusEnumUtil;
import com.aihoo.api.doctor.common.constant.UserRoleEnum;
...
public class MdtOrderServiceImpl implements MdtOrderService {
    ...
    public JsonResult receivingOrders(Map<String, String> map) {
        ...
        String idCard = Objects.requireNonNull(AuthUtil.getLoginUser()).getPapersNumbers();
        if (isPersonal) {
